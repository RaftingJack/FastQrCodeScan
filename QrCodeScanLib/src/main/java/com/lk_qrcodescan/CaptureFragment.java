...
public class CaptureFragment extends Fragment implements Callback {
    ...
    public void onAttach(Context context) {
        ...
        try {
            onQrCodeScanListener = (OnQrCodeScanListener) context;
        } catch (Exception e) {
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.activity_qr_scan, null);
        // 初始化 CameraManager
    ...
    public void handleDecode(String result) {
        ...
        onQrCodeScanListener.onScanResult(result);
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            handler = new CaptureActivityHandler(CaptureFragment.this);
        }
    }
